...
import '../../../games/minus/widgets/playing_card.dart';
import '../../../games/minus/widgets/bidding_overlay.dart';
import '../../../games/minus/widgets/deck_cut_overlay.dart';
import '../../../games/minus/widgets/scoreboard_overlay.dart';
import '../../../games/minus/widgets/spade_background.dart';
import '../../../games/minus/widgets/winner_overlay.dart';
...
class _GameTableScreenState extends ConsumerState<GameTableScreen> {
              ...
              return Container(
                ...
                child: Stack(
                  children: [
                    ...
                    ..._buildPlayerHands(ref, localHandAsync, myPlayedIds, pendingPlays, localPlayed, room.id, rotatedPlayers, localPlayerId, room.currentRound),
                    ...
                    if (room.winnerId != null)
                      Positioned.fill(
                        child: WinnerOverlay(
                          winnerName: players.any((p) => p.id == room.winnerId)
                              ? players.firstWhere((p) => p.id == room.winnerId).name
                              : "Winner",
  ...
  List<Widget> _buildPlayerHands(WidgetRef ref, AsyncValue<List<Map<String, dynamic>>> localHandAsync, Set<String> myPlayedIds, Set<String> pendingPlays, Set<String> localPlayed, String roomId, List<Player> rotatedPlayers, String localPlayerId, int currentRound) {
    List<Widget> hands = [];
